package com.example.sports_centar;
...
import com.example.sports_centar.fragments.listaRezervacija;
import com.example.sports_centar.fragments.listaTermina;
import com.example.sports_centar.fragments.pocetna;
...
public class MainActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.pocetna) {
            ...
            Util.otvoriFragmentKaoReplace(this,R.id.mjestoZaFragment, listaTermina.newInstance());

        } else if (id == R.id.rezervacije) {
            int KlijentID= Global.prijavljeniKlijent.KlijentID;
            Util.otvoriFragmentKaoReplace(this,R.id.mjestoZaFragment, listaRezervacija.newInstance(KlijentID));
